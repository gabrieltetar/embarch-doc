...
|---|---|---|---|
| `GET /status` — connected probes, plus `study_designer_schema_version`, `core_version`, and `binary_sha256` (a cached self-hash) | Shipped | unit, hw | §4, 13, 68 |
