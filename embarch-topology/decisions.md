...
|---|---|---|
| [decisions/crate.md](decisions/crate.md) | 1, 2, 3, 4, 6, 8, 13, 31 | A shared crate called live, in-process, with one implementation per question — and which half of it a consumer may link |
