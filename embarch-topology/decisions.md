...
| [decisions/enrollment.md](decisions/enrollment.md) | 14, 15, 16, 20, 27 | The one surface that needs a human, and the facts detection cannot produce |
| [decisions/validation.md](decisions/validation.md) | 21, 25, 26 | What the live identity gate asserts about the silicon on a link, and what it cannot |
