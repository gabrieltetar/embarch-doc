...
- **Link, don't restate.** [suite/features.md](suite/features.md) and [suite/roadmap.md](suite/roadmap.md) point at a decision rather than duplicating it. Exception: [embarch-user-guide.md](embarch-user-guide.md), where a getting-started guide that only links is useless.
