...
yourself.** Pass it the working directory `/home/gabriel/Github/embarch/embarch-doc` and the arguments
...
nothing else (`/home/gabriel/Github/embarch/embarch-doc/SUITE-REVIEW-PASS.md` §10).
...
1. **Is the pump latched?** `/home/gabriel/Github/embarch/.fleet/pump` exists and
   `/home/gabriel/Github/embarch/.fleet/tick` is fresh (under ~25 minutes) means a leg is alive or
   ...
   stop` in #embarch-fleet, or closing the listener window.
2. **Is every repo clean and current?** `git status --porcelain` and
   `git log --oneline -1` in `/home/gabriel/Github/embarch/embarch-doc` and each sub-project repo under
   `/home/gabriel/Github/embarch`. Uncommitted work is not a refusal — it is a fact the
...
- The working directory `/home/gabriel/Github/embarch/embarch-doc`, absolute.
- The `main` SHA of `/home/gabriel/Github/embarch/embarch-doc` and of every sub-project repo, read at
...
A report at `/home/gabriel/Github/embarch/embarch-doc/.claude/suite-review-<yyyy-mm-dd>.md` — uncommitted,
...
`/home/gabriel/Github/embarch/embarch-doc/SUITE-REVIEW-PASS.md` §7: **of what this run dropped, how much
