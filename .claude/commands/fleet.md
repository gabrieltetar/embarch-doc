...
> `U0AGQGSHM2P` at all. `robot_face` stays as the second line of that
...
> file `/home/gabriel/Github/embarch/embarch-doc/.claude/commands/fleet.md` — **read that file, never
...
>
> Post with `/home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-post.py`, never the Slack connector —
