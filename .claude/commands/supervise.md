...
run it yourself.** Working directory `/home/gabriel/Github/embarch/embarch-doc`; tell it: run one leg per
`.claude/leg.md` with `$ARGUMENTS`, and read the newest
`/home/gabriel/Github/embarch/embarch-fleet/supervisor-log.md` entries as your handoff. Then relay its final
