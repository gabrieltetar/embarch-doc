...
2. **Create the heartbeat**, one recurring cron job on `7-59/10 * * * *` — offset
   ...
   **exactly** the block below, and that block is the source of truth for the
   ...
   healthy.
3. Say so in the channel — `/home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-post.py "the watchdog
...
> `/home/gabriel/Github/embarch/.fleet/pump`**, then one post, which is this window's entire output:
>
> ```
...
>   --detail "tick mtime <mtime>; pump latch deleted at /home/gabriel/Github/embarch/.fleet/pump. This window cannot tell those four apart and does not guess."
> ```
>
