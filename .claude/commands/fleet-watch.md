...
4. Say so in the channel — `/home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-post.py "the watchdog
...
> **Delete `/home/gabriel/Github/embarch/.fleet/pump`**, then run
> `/home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-triage.py` — one read-only command that answers
...
>
> ```
> /home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-post.py \
>   "the fleet has not made progress since <time>, so I stopped it restarting" \
>   --action "<the triage verdict's own Recommended line>" \
>   --detail "<verdict>: <its one-line why>. tick mtime <mtime>; pump latch deleted at /home/gabriel/Github/embarch/.fleet/pump."
> ```
>
...
> failure this window exists for. **Then read `/home/gabriel/Github/embarch/.fleet/alerted`: if it
...
`/home/gabriel/Github/embarch/.fleet/tick.log`, so `/home/gabriel/Github/embarch/embarch-fleet/scripts/fleet-tick.py --report`
