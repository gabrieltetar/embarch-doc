...
- **Never `/fleet start`.** A re-arm is the owner's and cannot be delegated —
  ...
  notify him** (`/home/gabriel/Github/embarch/embarch-fleet/ops.md` §3): post it with `scripts/fleet-post.py`
...
is a leg's step 0 (`/home/gabriel/Github/embarch/embarch-fleet/ops.md` §3), which also lands or blocks
