...
`/home/gabriel/Github/embarch/embarch-doc/SUITE-REVIEW-PASS.md` — read §2 (the question), §3 (the bar), §4
...
Your spawn gives you `/home/gabriel/Github/embarch/embarch-doc`, `/home/gabriel/Github/embarch` and the SHAs the pass is
...
- **One proposed direction** — not a full design. The worker gets to design
  within its own sub-project (`/home/gabriel/Github/embarch/embarch-fleet/protocol.md` §5.4); you are naming
