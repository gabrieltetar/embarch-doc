...
`/home/gabriel/Github/embarch/embarch-doc/SUITE-REVIEW-PASS.md` — **read it now, all of it**, before
...
- `/home/gabriel/Github/embarch/embarch-doc/SUITE-REVIEW-PASS.md`, `embarch.md` (§4's architecture sketch and
...
- **The absolute path** `/home/gabriel/Github/embarch/embarch-doc` and `/home/gabriel/Github/embarch`, and the SHAs you
...
- **Split by blast radius.** A finding inside one sub-project is ordinary work
  ...
  `/home/gabriel/Github/embarch/embarch-fleet/protocol.md` §8 makes the supervisor's own and never
  dispatched.
...
**4. Write the report**, `/home/gabriel/Github/embarch/embarch-doc/.claude/suite-review-<yyyy-mm-dd>.md`.
