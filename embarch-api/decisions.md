...
| [Reaching Core](decisions/core-link.md) — addressing, artifact transfer, the shared client, the one auth-and-send funnel, the stack, older-Core parsing, one WSL2 predicate, the client crate's home | 11, 14, 15, 17, 26, 36, 37, 38, 55, 58, 62, 66 | 12.0 KB |
