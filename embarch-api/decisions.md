...
| [Per-tool wrapping](decisions/tool-wrapping.md) — why a given tool exists (or deliberately doesn't), its params, what its description promises | 23, 29, 34, 35, 41, 47, 52, 59 | 8.9 KB |
