...
- **The decision corpus has no headroom left.** `core-link.md` crossed on 2026-09-06 taking decision 55; it is 12,266 B against a 12,288 cap, `tasks/api/026-compact-api.md` filed. `surface.md` crossed the 11,059 B reserve line on 2026-09-07 taking decision 57; it is 11,785 B, `tasks/api/043-compact-api.md` filed. Three more sit a paragraph short of the reserve line and are **invisible to `check-doc-size.py`** until they cross: `zephyr.md` 11,056, `config.md` 11,008, `build.md` 10,934. The wrong answer to the next entry is whichever file has room — leg 015 did that with 96 bytes left.
