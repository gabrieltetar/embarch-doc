...
| `[[projects.targets]]` | — | — | — | **Retired 2026-09-05** ([../decisions](../decisions/shape.md) 53). A menu nothing ever selected from; a config still declaring one **fails at load naming the retirement**. Declare one `[[projects]]` entry per target instead |
