...
**Built 2026-09-04**, after [open.md](../open.md) carried it as config the interface doc stated as truth and nothing implemented — [../../embarch-decision-reversals.md](../../embarch-decision-reversals.md)'s shape 1. **Built, not retired**: the failure it prevents is silent and arrives in somebody else's commit. Three calls this entry did not make:
