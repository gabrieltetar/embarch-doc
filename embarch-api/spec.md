...
| capture cap | 64 KB retained, first 16 KB + last 48 KB | [assumed] — cap and split alike; no real Zephyr failure log has been measured here. The reasoning, and what would move the number: [decisions](decisions/build.md) 18 |
