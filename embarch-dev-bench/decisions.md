...
| [Addressing and scan-time discovery](decisions/scanning.md) — the bench's own address, GATT UUID byte order, name filtering, the advertiser census | 17, 23, 31, 32, 44 | 4.8 KB |
