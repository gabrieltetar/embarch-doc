...
- **Cross-vendor Zephyr-revision reconciliation** (decision 3) — whether two vendor families could share one workspace. Deliberately unsolved; the per-family layout works and nothing forces it.
