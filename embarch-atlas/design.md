...
- 2026-08-25 — Suite-wide design pass: transport deliberately left undecided (user's call), with the deciding fact — engine weight vs. `embarch-api` linking it — recorded so it is not re-derived on resume.
