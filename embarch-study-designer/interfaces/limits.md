...
| `MAX_DISCOVERED_SERVICES` | 8 | `GattServiceInfo` per `StepResult.gatt_services` (decisions 31/32, §4.3a) | [measured 2026-08-23, superseding a mismatched 2026-08-26 note in this file] `reference-dut-fw`'s `lib/ble/ble_def.h`/`ble.c` declares 2 services today (`src/limits.rs:80-84`), with headroom for a DUT this crate hasn't seen yet |
