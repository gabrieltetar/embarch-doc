...
|---|---|
| [Crate shape and boundaries](decisions/crate.md) — what it links, how it reaches three consumers in two languages, and what checks its feature cells | 1, 2, 5, 7, 8, 23, 64 |
