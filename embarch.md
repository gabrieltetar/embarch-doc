...
- [embarch-stream-pipeline-proposal.md](embarch-stream-pipeline-proposal.md) — **inbound half accepted 2026-08-25** (folded into [embarch-study-designer/decisions.md](embarch-study-designer/decisions.md) §3 decision 39); the outbound half — the authored `StreamSend` step for writing to a DUT's shell — is **still a proposal, not accepted**
