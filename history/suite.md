...
### Added
- Reversals row 111: a 2026-09-02 compaction dropped core decision 32's two correction paragraphs, and the wrong framing stood 15 days.
...
### Changed
- All four Rust consumers' READMEs now say which sibling repos must be cloned beside them to build; none was self-contained and none said so.
