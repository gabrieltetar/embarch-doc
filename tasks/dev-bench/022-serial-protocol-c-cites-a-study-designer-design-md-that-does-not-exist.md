# 022 — `serial_protocol.c` cites an `embarch-study-designer/design.md §3` that does not exist
...
`embarch-dev-bench/app/src/serial_protocol.c` has **37** citations of the dead
...
- [ ] `grep -n "design\.md\|milestone-" app/src/serial_protocol.c` returns zero.
