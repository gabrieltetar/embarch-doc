...
**State:** open
**Source:** found wiring up a real repo (client-fw) on 2026-09-09; `embarch-api/src/zephyr.rs::scan_apps`
**Scope:** api
**Hardware:** none
**Owner:** no
...
Real, not hypothetical. `client-fw` has `apps/{client,driver_test,mlp_test}`
and two boards (`client_core`, upstream `nucleo_g0b1re`) — exactly the
...
(`/home/gabriel/Github/client/client-fw/embarch/embarch.toml`, whose
