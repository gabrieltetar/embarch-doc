...
- [x] All three files out of reserve. `spec.md` (9006 B, 87.9%), `open.md` (4601 B, 89.9%, repaid by `umbrella/020`), and `decisions/doctor.md` (6188 B, 50.4%) with decision 22 split out to `decisions/bind.md` (8465 B, 68.9%) — `umbrella/020`, 2026-09-06. **The pass itself is still owed** and the rest of these boxes are open.
