...
- [ ] `assets/app.js` lines 1155, 1192 and 1198 cite decision 42, with 1155 carrying the repo prefix.
- [ ] The nine other `decision 40` sites are confirmed untouched and confirmed still correct.
- [ ] The `decisions/surfaces.md` pointer at 163-164 is either fixed or reported as still correct.
